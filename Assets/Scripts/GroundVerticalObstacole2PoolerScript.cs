...
public class GroundVerticalObstacole2PoolerScript : MonoBehaviour
{
    public static GroundVerticalObstacole2PoolerScript current; //per interfecciare con altri script, in moda da richiamarla
